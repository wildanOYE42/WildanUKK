            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <a href="<?= base_url('boss/add_petugas'); ?>" class="btn btn-success mb-3"><i class="fa fa-plus"></i> Tambah Data Petugas</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($petugas as $p) { ?>
                                        <tr>
                                            ...
                                            <td><?= $p->username; ?></td>
                                            <td>
                                                <a href="<?= base_url('boss/del_petugas/') . $p->id_petugas; ?>" class="btn btn-danger btn-sm tombol-hapus"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('boss/editLevelPetugas'); ?>" method="post">
