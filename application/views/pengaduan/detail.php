          ...
          <div class="row mb-3">
            <div class="col-lg-6">
              <div class="card shadow">
                ...
                <div class="card-body">
                  <hr>
                  <?php if ($pengaduan->verifikasi != "ditolak") : ?>
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal"><i class="fa fa-edit"></i> Edit Status</button>
                    <?php endif; ?>
                  <a href="<?= base_url('pengaduan'); ?>" class="btn btn-dark"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card shadow">
                ...
                <p><?= $pengaduan->isi_laporan; ?></p>
                  ...
                  <br>
                  <small>Status : <?= $pengaduan->status ?></small>
                  <br>
                    ...
                    <?php foreach ($tanggapan as $t) { ?>
                      <div class="card bg-light my-2">
                        <div class="mx-2 my-2">
                          ...
                          <?php if ($t->id_petugas == $pengguna['id_petugas']) : ?>
