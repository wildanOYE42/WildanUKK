...
class B_user extends CI_Model
{
    ...
    public function getTanggapanJoinAdmin($id)
    {
        ...
        $query = "SELECT * FROM tanggapan INNER JOIN petugas ON tanggapan.id_petugas = petugas.id_petugas WHERE tanggapan.id_pengaduan = $id_pengaduan ORDER BY tanggapan.id_tanggapan DESC";
        return $this->db->query($query)->result();
    }
